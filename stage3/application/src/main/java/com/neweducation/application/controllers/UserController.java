...
public class UserController extends AbstractController {
	...
	public Map<String, Object> login(@RequestParam(value = "login") String login, @RequestParam(value = "password") String password) {
		...
		response.put("uprawnienie", Uprawnienie.STUDENT);
